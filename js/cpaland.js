(function () {
    ...
    CpaLand.prototype = {
        ...
        setFormAction: function (domain) {
            ...
            var orderForms = document.querySelectorAll('.cpa__order_form'),
        ...
        appendCss: function(jaw, callback) {
            ...
            link.href = '/css/cpa-magick.min.css';
            link.type = "text/css";
            link.rel = "stylesheet";
        ...
        showSideNotify: function() {
            ...
            scriptLp.setAttribute('src', '/js/lastpacknotify.js');
            if (_this.appendingCss) {
